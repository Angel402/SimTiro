...
public class HealthManager : NetworkBehaviour
{
	...
	public class DamageInfo
	{
		...
		public GameObject bodyPart;               // The body part (Collider) that was hit (optional).
		public GameObject origin;                // The game object that generated the hit (optional).

		public DamageInfo(Vector3 location, Vector3 direction, float damage, GameObject bodyPart=null, GameObject origin=null)
		{
	...
	[SerializeField] protected internal List<GameObject> bodyParts;
	...
	public virtual void TakeDamageMessageSender(Vector3 location, Vector3 direction, float damage, GameObject bodyPart=null, GameObject origin=null)
	{
	}

	public virtual void TakeDamage(Vector3 location, Vector3 direction, float damage, GameObject bodyPart=null, GameObject origin=null)
	{
	}
	...
	{
		this.TakeDamageMessageSender(damageInfo.location, damageInfo.direction, damageInfo.damage, damageInfo.bodyPart, damageInfo.origin);
	}
}
