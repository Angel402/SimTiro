...
namespace UI
{
    public class PlayFabLogin : MonoBehaviour
    {
        ...
        [SerializeField] private SwitchManager hostSwitch;
        ...
        public void TryLogin()
        {
            ...
            {
                Username = loginName.text, Password = loginPassword.text, InfoRequestParameters =
        ...
        private void OnLoginSuccess(LoginResult result)
        {
            ...
            ServiceLocator.Instance.GetService<ILoginUserData>().SetUsername(loginName.text);
            if (hostSwitch.isOn)
            {
                StartHost();
            }
